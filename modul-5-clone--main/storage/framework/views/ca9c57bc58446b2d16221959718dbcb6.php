...
=> $employee->employee_id])); ?>" class="btn btn-outline-dark btn-sm me
2"><i class="bi-person-lines-fill"></i></a> 
<a href="<?php echo e(route('employees.edit', ['employee' => $employee->employee_id])); ?>" class="btn btn-outline-dark btn-sm">
    <i class="bi-pencil"></i>
</a>
                        ...
                        <div> 
                            <form action="<?php echo e(route('employees.destroy', 
['employee' => $employee->employee_id])); ?>" method="POST"> 
                                <?php echo csrf_field(); ?> 
                                <?php echo method_field('delete'); ?> 
                                <button type="submit" class="btn btn
outline-dark btn-sm me-2"><i class="bi-trash"></i></button> 
                            </form> 
                        </div> 
                    </div> 
                </td> 
...
<?php /**PATH C:\.vscode\.vscode\PBOWEW\.vscode\Semester 3\modul-5-clone--main\resources\views/employee/index.blade.php ENDPATH**/ ?>