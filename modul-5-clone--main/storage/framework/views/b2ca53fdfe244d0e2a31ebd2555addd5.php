...
id="navbarSupportedContent"> 
                ...
                <ul class="navbar-nav flex-row flex-wrap"> 
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(route('employees.index')); ?>" class="nav-link active">Employee 
List</a></li> 
                </ul> 
 
                <hr class="d-lg-none text-white-50"> 
 
                <a href="<?php echo e(route('profile')); ?>" class="btn btn-outline
...
</html> <?php /**PATH C:\.vscode\.vscode\PBOWEW\.vscode\Semester 3\modul-5-clone--main\resources\views/employee/show.blade.php ENDPATH**/ ?>